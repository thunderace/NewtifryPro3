package com.newtifry.pro3.EnhancedListView;
...
*/
     ...
     */
    View mView;
    public EnhancedListView setDismissCallback(OnDismissCallback dismissCallback, View view) {
...
//        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if(mTouchBeforeAutoHide && (mSnackBar != null && mSnackBar.isShown()) /* mUndoPopup.isShowing()*/) {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (noAnimationLeft) {
                    ...
                    if(!mUndoActions.isEmpty()) {
                        ...
                        // Show undo popup
	                    mSnackBar = Snackbar.make(mView, getResources().getString(R.string.elv_item_deleted), Snackbar.LENGTH_LONG)
				                    .setDuration(mUndoHideDelay)
				                    .setAction(getResources().getString(R.string.elv_undo), new UndoClickListener());
                        mSnackBar.show();
/*
                        float yLocationOffset = resources.getDimension(R.dimen.elv_undo_bottom_offset) + navBarHeight;
